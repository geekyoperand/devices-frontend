      ...
      <div className="device-container" key={id}>
        ...
        <div className="device-action">
          <Button
            id="edit-button"
            type="primary"
            onClick={() => this.setState({ isUpdateDeviceModalOpened: true })}
          >
            Edit
          </Button>
          <Button
        ...
        {isUpdateDeviceModalOpened && (
          <Modal
            data={this.props}
            isVisible={(val) =>
              this.setState({ isUpdateDeviceModalOpened: val })
            }
            onAddEdit={(val) => this.onDeviceUpdation(val)}
          />
        )}
      </div>
    );
